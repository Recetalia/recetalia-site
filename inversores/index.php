...
<head>
    ...
    <meta name="description" content="Programa de Participación Societaria para Médicos Especialistas" />
    <meta name="author" content="Doctor Consultas" />
    <title>Recetalia - Programa de inversores</title>
    <!--  Add Favicon Icon-->
            ...
            <div class="row">
               <div class="col-md-7">
                  <div class="themeix-slider-content">
                     <h1 class="wow fadeIn"  data-wow-duration="1s"> Programa de Participación Societaria para Médicos Especialistas.</h1>
                     <p class="wow fadeIn"  data-wow-duration="3s">RECETALIA – La Primera Plataforma de Receta Digital de Uruguay.</p>
                     <div class="themeix-slider-btn wow fadeIn"  data-wow-duration="5s">
                        <!--<a href="blog-left-sidebar.html" class="btn-style-1 btn btn-primary">Our Blog</a>-->
                    <a href="#ContactSet" target="_top" class="btn-style-2 btn btn-primary">Contactar</a>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 wow fadeIn"  data-wow-duration="1s">
                    <div class="section-title margin-bottom-30">
                        ...
                        <p>Luego de un profundo análisis del sector de la Salud en LATAM; entendimos que había una
enorme necesidad de optimizar el proceso de prescripción de medicamentos y paraclínica.
</p>
					 <p>Así nació RECETALIA, la Primera Plataforma de Receta Digital de Uruguay, desarrollada de
acuerdo a las normas del Gobierno, AGESIC y SALUD.UY</p>

                    </div>
					<a href="https://recetalia.com" target="_blank" class="btn btn-primary">Ver Sitio</a>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <div class="feature-logo">
                            <h2>01</h2>
                            <img src="images/feature-logo.png" alt="feature logo" />
                        </div>
                        <div class="feature-details">
                            <h4>Paso 1</h4>
                            <p>El médico emite la receta digital y se genera un documento único con código de identificación.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box">
                        <div class="feature-logo">
                            <h2>02</h2>
                            <img src="images/feature-logo2.png" alt="feature logo" />
                        </div>
                        <div class="feature-details">
                            <h4>Paso 2</h4>
                            <p>Las farmacias acceden a las recetas digitales activas y el paciente recibe un copia.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box m-0">
                        <div class="feature-logo">
                            <h2>03</h2>
                            <img src="images/feature-logo3.png" alt="feature logo" />
                        </div>
                        <div class="feature-details">
                            <h4>Paso 3</h4>
                            <p>El paciente elige la farmacia de su preferencia, retira y/o recibe la medicación solo con 
número de C.I. </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="about-section section-spacing bg-color1 wow fadeIn"  data-wow-duration="1s">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="about-ads-details">
                        <div class="section-title  margin-bottom-30">
                            <h4>OPORTUNIDAD</h4>
                            <p>Desde un inicio entendimos el valor estratégico que aportan los médicos, en términos de
knowhow y conocimiento de primera mano del sector. Así estructuramos este mecanismo
a través del cuál hemos canalizado el ingreso de los Socios Médicos Inversores.</p>
							<p>Al día de hoy contamos con más de 25 Socios Médicos Especialistas, que fueron
estratégicamente seleccionados en base a su potencial para enriquecer a nuestra
compañía.</p>
							<p>Con el objetivo de que más médicos puedan ser parte, hemos abierto esta oportunidad,
exclusiva para especialistas, de convertirse en socios mediante la adquisición de una
participación accionaria a un valor accesible..</p>
						<? /*
							<p style="color:#12BCEC"><b>Precio para médicos especialistas: USD 2.300 por Acción.</b></p>
							<p style="color:#12BCEC"><b>Precio especial para Socio Inversor de DoctorConsultas: USD 1.780 por Acción.</b></p>
							*/
							?>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="about-ads-thumb">
                        <img src="images/moble-img.jpg" alt="mobile img" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="about-contact-content section-spacing bg-color4 themeix-highlight wow fadeIn"  data-wow-duration="1s">>
            ...
            <div class="container-fluid">
                <div class="section-title margin-bottom-60 section-inverse">
                    <span>&nbsp;</span>
                    <h4>Contacto</h4>
                    <p>Si te interesa ser parte de nuestra compañía, envianos tus datos y nos pondremos en contacto
contigo para darte más información.</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="row">
								...
								<div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="CJP" name="cjp" id="cjp">
                                    </div>
                                </div>
								<div class="col-md-6">
                                    <div class="form-group">
								...
								<div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Especialidad" name="speciality" id="speciality">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea rows="2" class="form-control" placeholder="Mensaje" name="comment" id="comment"></textarea>
                                    </div>
                                </div>
								<!---
                                <div class="col-md-12">
