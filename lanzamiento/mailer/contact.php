...
if(trim($name) == '') {
	...
	echo '<div class="alert alert-error">Ingresa un Apellido.</div>';
	exit();
...
$e_subject = 'Desde el Lanzamiento de Recetalia';
...
$e_body = "CONTACTADO POR: $name $lastname, Tel $phone , Epecialidad:." . PHP_EOL . PHP_EOL;
$e_content = "\"$speciality\"" . PHP_EOL . PHP_EOL;
$e_reply = "CONTACTO $name , EMAIL $email ";

$msg = wordwrap( $e_body . $e_content . $e_reply, 70 );

$headers = "From: $email" . PHP_EOL;
$headers .= "Reply-To: $email" . PHP_EOL;
$headers .= "Cc: hello@recetalia.com" . PHP_EOL;
